          ...
          <div className="lg:col-span-5 relative">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <img
                  src="https://www.rvmpersianaspr.com.br/assets/experience-4-yhK4lzE2.jpg"
                  alt="Instalação de persiana de rolo em sala moderna"
                  referrerPolicy="no-referrer"
                  className="rounded-2xl object-cover h-64 w-full border border-slate-100 shadow-md"
                />
                <img
                  src="https://www.rvmpersianaspr.com.br/assets/experience-5-Bihkc93r.jpg"
                  alt="Sala iluminada por persianas double vision"
                  referrerPolicy="no-referrer"
              ...
              <div className="pt-8">
                <img
                  src="https://www.rvmpersianaspr.com.br/assets/experience-6-DGBbsF9o.jpg"
                  alt="Janela decorada com persianas horizontais de madeira"
                  referrerPolicy="no-referrer"
